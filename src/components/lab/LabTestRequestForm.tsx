...
export function LabTestRequestForm({ open, onOpenChange, patientId }: LabTestRequestFormProps) {
  ...
  const handleSelectAll = (category: string) => {
    const categoryData = testCategories.find(c => c.name === category);
  ...
  const handleSubmit = () => {
    ...
    toast.success(`Lab request sent for ${patient?.name}`, {
      description: `${getTotalSelectedTests()} tests requested`,
    });
