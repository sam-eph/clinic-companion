...
export function LabResultEntryForm({ open, onOpenChange, request }: LabResultEntryFormProps) {
  ...
  const handleSubmit = () => {
    ...
    toast.success('Results uploaded successfully', {
      description: `${filledResults.length} test results saved for ${request?.patientName}`,
    });
    setResults({});
    onOpenChange(false);
  };
